...
# Use the specific demo image
SOURCE_IMG="$BASE_DIR/demo_images/id10010#Fi21gDronE4#001686#002204_00079.jpg"
...
# Run the emotion inference script (modified from the original inference.py)
