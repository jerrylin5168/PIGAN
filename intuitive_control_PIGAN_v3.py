...
def get_control(input_name, args):
    ...
    #mouth: postive smile 
    #eye: bigger(postive), smaller eye
    
    if args.happy:
        control_dict['expression_happiness'] = control_dict['expression_center'] + \
            (control_dict['expression_mouth'] - control_dict['expression_center']) * intensity_scale * 0.7
        ...
        control_dict['expression_sadness'] = control_dict['expression_center'] + \
            ...
            (control_dict['expression_eyes'] - control_dict['expression_center']) * (0.4 * intensity_scale) + \
            (control_dict['expression_mouth'] - control_dict['expression_center']) * (-0.75 * intensity_scale)
        ...
        control_dict['expression_anger'] = - (control_dict['expression_eyebrow']) * 0.9 * intensity_scale - \
            (control_dict['expression_eyes']) * 0.15 * intensity_scale - \
            (control_dict['expression_mouth']) * 0.8 * intensity_scale
        ...
        control_dict['expression_fear'] = control_dict['expression_center'] + \
            (control_dict['expression_eyes'] - control_dict['expression_center']) * (-0.4 * intensity_scale) + \
            (control_dict['expression_eyebrow'] - control_dict['expression_center']) * (0.6 * intensity_scale) + \
            (control_dict['expression_mouth'] - control_dict['expression_center']) * (-0.25 * intensity_scale)
        ...
        control_dict['expression_surprise'] = control_dict['expression_center'] + \
            (control_dict['expression_eyes'] - control_dict['expression_center']) * (-0.45 * intensity_scale) + \
            (control_dict['expression_eyebrow'] - control_dict['expression_center']) * (0.6 * intensity_scale) + \
            (control_dict['expression_mouth'] - control_dict['expression_center']) * (-0.15 * intensity_scale)
...
if __name__ == '__main__':
    ...
    # Added print-out of the input emotion and intensity at the end.
    ...
    print(f"Input Emotion: {final_emotion}, Level: {args.intensity}")
